...
public class Hub3 : MonoBehaviour
{
    ...
    {
        Portal3[] allPortals = GetComponentsInChildren<Portal3>();

        for (int i = 0; i < 3; i++)
        {
            Portal3 portal1 = allPortals[i];
            Portal3 portal2 = allPortals[Random.Range(0, 3)];
