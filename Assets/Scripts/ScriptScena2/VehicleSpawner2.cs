...
{ 
    ...
    public Vehicle2[] randomlySpawnableVehicles;
    ...
    private void HandleNextEvent()
    {
        ...
        Vehicle2 prefab = e.vehicle == null ? randomlySpawnableVehicles[Random.Range(0, randomlySpawnableVehicles.Length)] : e.vehicle;
        Vehicle2 vehicle = Instantiate(prefab, spawnPosition.position, spawnPosition.rotation);
