...
public class Hub4 : MonoBehaviour
{
    ...
    {
        Portal4[] allPortals = GetComponentsInChildren<Portal4>();

        for (int i = 0; i < 3; i++)
        {
            Portal4 portal1 = allPortals[i];
            Portal4 portal2 = allPortals[Random.Range(0, 3)];
            ...
            AudioClip audioClip = portal1.musicAudioClip;
            portal1.musicAudioClip = portal2.musicAudioClip;
            portal2.musicAudioClip = audioClip;
        }
    }
}
