...
public class GameController4 : MonoBehaviour
{
    ...
    public Hub4 hub;
    public Crossing4 crossing;
    public AudioManager4 audioManager;
    ...
    public IEnumerator WaitAudioToBeFinishedAndEnablePlayerAndCars(float lengthAudio)
    {
        ...
        // Start all vehicles
        foreach (var vehicle in FindObjectsOfType<Vehicle4>())
        {
        ...
        // Start all spawners
        foreach (var spawner in FindObjectsOfType<VehicleSpawner4>())
        {
    ...
    public void LoseWithMusic()
    {
        ...
        float lengthAudio = audioManager.PlayWrongCrossingMusic();
        StartCoroutine(WaitAudioToBeFinishedAndEnablePlayer(lengthAudio));
    }
